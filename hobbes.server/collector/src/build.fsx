...
Target.create "Bundle" (fun _ ->
    let serverDir = Path.combine deployDir "Collector"
...
Target.create "BuildImage" (fun _ ->
    if System.IO.Directory.Exists("./deploy/Collector") |> not then failwith "Doh"
    //if System.IO.Directory.Exists("./deploy/Server/db") |> not then failwith "with What??"
    let arguments = "build -t collector --platform linux ." |> String.split ' ' |> Arguments.OfArgs
